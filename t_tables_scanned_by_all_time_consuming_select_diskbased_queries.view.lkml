view: t_tables_scanned_by_all_time_consuming_select_diskbased_queries {
  sql_table_name: nbs_admin.t_tables_scanned_by_all_time_consuming_select_diskbased_queries ;;
