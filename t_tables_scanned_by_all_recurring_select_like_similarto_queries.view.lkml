view: t_tables_scanned_by_all_recurring_select_like_similarto_queries {
  sql_table_name: nbs_admin.t_tables_scanned_by_all_recurring_select_like_similarto_queries ;;
